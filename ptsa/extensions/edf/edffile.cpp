...
PYBIND11_MODULE(edffile, m)
{
    ...
    .. _EDFlib: https://www.teuniz.net/edflib/
        ...
        .def("read_samples",py::overload_cast<std::vector<std::string>,int,long long>(&EDFFile::read_samples),
             py::arg("channel"), py::arg("samples"), py::arg("offset") = 0)
        .def("read_samples", py::overload_cast<std::vector<int>,int,long long> (&EDFFile::read_samples),
             py::arg("channel"), py::arg("samples"), py::arg("offset") = 0)

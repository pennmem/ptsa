...
class test_filters(unittest.TestCase):
    ...
    def test_event_data_chopper(self):
        ...
        sedc = EventDataChopper(events=self.base_events, session_data=session_eegs, start_time=0.0, end_time=1.6,
                                buffer_time=1.0)
    ...
    def test_wavelets_with_event_data_chopper(self):
        ...
        sedc = EventDataChopper(events=self.base_events, session_data=pow_wavelet_session, start_time=0.0, end_time=1.6,
                                buffer_time=1.0)

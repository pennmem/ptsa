...
# morlet_dir = join(root_dir,'morlet')
morlet_dir = join(root_dir,'ptsa','extensions','morlet')
print morlet_dir
print join(morlet_dir,'morlet.i')
...
# morlet_module = Extension('ptsa_cpp.morlet._morlet',
#                            sources=[join(morlet_dir,'morlet.cpp'),join(morlet_dir,'morlet.i')],
#                            swig_opts=['-c++'],
#                            include_dirs=[join(third_party_install_dir,'include'),numpy.get_include()],
#                            library_dirs=[join(third_party_install_dir,'lib')],
...
#       packages = ['ptsa_cpp.morlet'],
#       py_modules = ['ptsa_cpp.morlet']
#       )
